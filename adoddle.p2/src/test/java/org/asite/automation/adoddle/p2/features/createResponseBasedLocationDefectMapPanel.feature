Feature: Create Response Based Location Defect From Map Panel
...
|UK|Automation_FieldEnabled_UK_WS|MPL_Defect_Site|MPL_Defect_Location|Auto Test|RFI Builder|
#|US|Automation_FieldEnabled_US_WS|MPL_Defect_Site|MPL_Defect_Location|Auto Test|RFI Builder|
#|AUS|Automation_FieldEnabled_AUS_WS|MPL_Defect_Site|MPL_Defect_Location|Auto Test|RFI Builder|