Feature: PublishPDF via Workflow on StatusChange

@P2T4
Scenario Outline: Publish Document Revision as PDF on Status Change
...
And I have Distribute file "AutoTestArchitectureDesign" to users "TC Bloggs" AND "RFI Bloggs" with action as "For Status Change" successfully
And I have created multiple comments successfully
When I switch to <User> user
Given I am on "Files" tab
And I have search file "AutoTestArchitectureDesign" with action as "For Status Change" successfully
When I performed "For Status Change" action successfully
