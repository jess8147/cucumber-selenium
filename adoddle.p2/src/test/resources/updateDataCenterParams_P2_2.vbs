...
Sub replaceParameterizedDataCenter(filePath)
	...
	For i=0 To UBound(arrLines)
		...
		myLine = arrLines(i)
		If InStr(myLine,"@P2T1")> 0 OR InStr(myLine,"@P2T2")> 0 OR InStr(myLine,"@P2T3")> 0 OR InStr(myLine,"@P2T4")> 0 OR InStr(myLine,"@P2T6")> 0 Then
			If InStr(myLine, "@P2T1") > 0 Then
				myline = Replace(myLine, "@P2T1", "@P2Test1")
			ElseIf InStr(myLine, "@P2T2") > 0 Then
			...
			ElseIf InStr(myLine, "@P2T6") > 0 Then
				myline = Replace(myLine, "@P2T6", "@P2Test1")
			Else
				myFile = myLine
			End If
		End If
		
		If InStr(myLine,"@P2T5")> 0 OR InStr(myLine,"@P2T7")> 0 OR InStr(myLine,"@P2T8")> 0 Then
			...
			ElseIf InStr(myLine, "@P2T8") > 0 Then
				myline = Replace(myLine, "@P2T8", "@P2Test2")
			Else
				myFile = myLine
			End If
		End If
