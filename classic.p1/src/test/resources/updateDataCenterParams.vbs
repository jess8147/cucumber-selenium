...
Set featureFolder = objFSO.getFolder(projectFolder & "\src\test\java\org\asite\automation\classic\p1\features\")
...
Sub replaceParameterizedDataCenter(filePath)
	...
	For i=0 To UBound(arrLines)
		...
		myLine = arrLines(i)
		If InStr(myLine,"@P1T2")> 0 OR InStr(myLine,"@P1T3")> 0 OR InStr(myLine,"@P1T5")> 0 Then
			If InStr(myLine, "@P1T2") > 0 Then
				myline = Replace(myLine, "@P1T2", "@P1Test")
			ElseIf InStr(myLine, "@P1T3") > 0 Then
				myline = Replace(myLine, "@P1T3", "@P1Test")
