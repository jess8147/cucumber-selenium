Feature: Create Response Based Site Defect From LH Panel
...
|UK|Automation_FieldEnabled_UK_WS|LHS_Defect_Site|Auto Test|RFI Builder|
#|US|Automation_FieldEnabled_US_WS|LHS_Defect_Site|Auto Test|RFI Builder|
#|AUS|Automation_FieldEnabled_AUS_WS|LHS_Defect_Site|Auto Test|RFI Builder|