Feature: Update File Privacy AllSupersededVersions Private

@P2T3
Scenario Outline: UpdateFilePrivacy-AllSupersededVersions_Private
Given Project DC <DC_Center> is available
And I am already logged in with multi-Project user
Given I am on "Files" tab
And I have focus on "AutomationTest_Folder3" folder in <Project>
And I Search "AutoTestFile_WF_UpdatePrivacy" AND I validate all oldRevisions access modifiers for scenario "AllSupersededVersions_Private"
...
And I Enter Mandatory Attributes of TestFile for scenario "AllSupersededVersions_Private"
And I Click Upload Button
And I have focus on "AutomationTest_Folder3" folder in <Project>
Then "AutoTestFile_WF_UpdatePrivacy" Should Available in Document Listing having Workflow Status as "RUNNING" AND Workflow Stage as "For Status Change" for scenario "AllSupersededVersions_Private"
And I switch to <User2> user
Given I am on "Files" tab
And I have focus on "AutomationTest_Folder3" folder in <Project>
When I Search "AutoTestFile_WF_UpdatePrivacy" having MyActions as "For Status Change" AND I click "For Status Change" for scenario "AllSupersededVersions_Private"
...
And I Validate "AutoTestFile_WF_UpdatePrivacy" file version for scenario "AllSupersededVersions_Private"
Examples: 
