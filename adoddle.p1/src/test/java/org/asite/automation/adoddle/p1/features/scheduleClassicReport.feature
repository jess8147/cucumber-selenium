Feature: Create Schedule Report - Classic

@P1T6
Scenario Outline: Verify the Legacy Report created in Classic
...
When I entered "Classic Report" And I select Workspace of <Project_Name>
...
And "Classic" report for "PDF" Preview verify on "Listing Page"
And "Classic" report for "PDF" Preview verify on "Edit Page"
...
And I select <Project_Name> project and select "Reports" folder for scheduling
...
@P1T6
Scenario Outline: Deactivate Classic Schedule Report
Given Project DC <DC_Center> is available
