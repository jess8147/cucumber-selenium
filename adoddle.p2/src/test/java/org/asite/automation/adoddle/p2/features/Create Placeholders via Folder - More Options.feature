Feature: Create Placeholders via Folder - More Options

@P2T7
Scenario Outline: Create Placeholders via More Options
...
When I click on "Publish Files Placeholder" icon on Options popup
