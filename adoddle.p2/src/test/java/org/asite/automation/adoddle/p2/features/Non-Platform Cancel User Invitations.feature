Feature: Non-Platform Cancel User Invitations

@P2T5
Scenario Outline: Invited Non-Platform Users for "Cancel" Invitation
...
And I enter RoleName for "NPT" users "Cancel" Invitations
...
When I enter FirstName and LastName and Email And I Select Role for invited User And entered Custom Message for "Cancel" Invitations
