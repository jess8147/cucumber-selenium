Feature: Platform Reject-Decline User Invitations

@P2T5
Scenario Outline: Invited Platform Users for "Reject/Decline" Invitation
...
And I enter RoleName for "PT" users "Decline" Invitations
...
When I enter FirstName and LastName and Email And I Select Role for Platform User And entered Custom Message for "Decline" Invitations
